...
const extraTools = require('./custom_modules/extraTools');
...
app.get('/robots.txt', (request, response) => { // https://stackoverflow.com/a/20265155
    response.type('text/plain');
    response.sendFile('robots.txt', { root: __dirname });
});

app.get('*', (request, response) => { // https://stackoverflow.com/a/6528951
